...
# larus <img src="man/figures/logo_larus_png.png" align="right" width = "120px"/>
...
``` r
check_trip_criteria(my_params=Params_00criteria)
#> [1] "From 134 trips: 20.9% were trip_longer_than_30mins and 79.1% were trip_shorter_than_30mins. Trips shorter than 30 minutes are not considered real trips. Remove these trips from analyses. "
```
...
plot_trips(my_locs=Path_trips %>%
  dplyr::filter(trip_number=='trip_00002'),my_central_location=my_central_location)+
